#! /usr/bin/env python
# You can ignore this bit for now
import sys
from music21 import *
...
##########################################################################
#                                                                        #
# The section between these blocks is what we're looking at for lesson 1 #
#                         LOOK BELOW HERE                                #
#                         \/     \/    \/                                #
##########################################################################
...
#bar6_right[-1].tie = tie.Tie('start')
bar6_right.append(note.Note('e4'))
#bar6_right[-1].tie = tie.Tie('continue')
bar6_right.append(note.Note('g4'))
#bar6_right[-1].tie = tie.Tie('stop')
...
# You can ignore everything below here for now
